	...
	<div class="modal fade" id="replyModal" role="dialog">
     ...
     <script>
        window.onload = function() {
            ...
            //수정, 삭제
            /*
            document.getElementById('.replyModify').onclick = function(e) {
                e.preventDefault();
           ...
           document.getElementById('modalDelBtn').onclick = () => {
               ...
               */
               ...
               fetch('${pageContext.request.contextPath}/reply/' + rno, {
                    ...
                    body: replyPw //JSON은 문자열로 받기 때문에 JSON 빼기
               })
               .then(res => res.text())
               .then(data => {
                    if(data === 'delSuccess') {
            ...
            function parseTime(regDate) {
                ...
                let time;
                if(gap < 60 * 60 * 24 * 1000) { //하루보다 작냐 ? 
                    if(gap < 60 * 60 * 1000) { //한시간 보다 작냐 ?
                        time = '방금 전';
                    } else {
