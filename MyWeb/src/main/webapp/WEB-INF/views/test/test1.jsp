...
<body>
    ...
    <input type="checkbox" name="hobby" value="music"> 축구
    <input type="checkbox" name="hobby" value="game"> 축구
    ...
    <script>
        ...
        $sendBtn.onclick = function(e) {
            const name = document.querySelector('input[name=name]').value; // 이름과 취미를 비교하기위해서는 name 밖에 없기 때문
            ...
            */
            ...
            //JS -> JSON으로 변경: JSON.stringfy(arg)
