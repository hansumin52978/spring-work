...
<body>
	...
	<script>
				...
				.then(list => {
					...
					for(board of list) {
						...
						<div class="like-inner">
							<!--좋아요-->
							<img src="${pageContext.request.contextPath}/img/icon.jpg"> <span>777</span>
						</div>
						<div class="link-inner">
							<a href="##"><i class="glyphicon glyphicon-thumbs-up"></i>좋아요</a>
		...
		$contentDiv.addEventListener('click', e => {
			...
			document.getElementById('.modal-inner').style.display = 'inline';
			document.getElementById('.snsWriter').style.display = 'inline';
			document.getElementById('.link-inner').style.display = 'inline';
