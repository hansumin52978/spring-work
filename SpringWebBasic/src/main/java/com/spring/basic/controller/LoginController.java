...
public class LoginController {
	...
	public String loginForm() {
		System.out.println("요청 URL : /hw/s-login-form : GET");
		return "response/s-form";
	}
	
	//로그인 검증 요청 처리
	@PostMapping("/s-login-check")
	public String loginResult(String id,
								String pw, Model model) {
		System.out.println("요청 URL : /hw/s-login-check : POST");
    ...
    s-result.jsp에서 전송된 로그인 여부를 확인해서 적용한 화면을 응답하시면 되겠습니다.
